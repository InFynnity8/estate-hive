                ...
                <div className="flex flex-1 items-center justify-center">
                    <div className="w-full px-20 gap-10 flex flex-col">
                        <div className="flex flex-col gap-3">
                            <h1 className='font-medium text-2xl'>Email verification</h1>
                            <div className="">
                                <p className="text-muted-foreground text-sm text-balance">We just sent a verification link to
                                    estate@hive.com </p>
                                <p className="text-muted-foreground text-sm text-balance">Click on the link to proceed</p>
                            </div>
                        </div>
